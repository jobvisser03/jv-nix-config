    ...
    in {
      options.jv.hyprland = {
        monitorv2 = lib.mkOption {
          ...
          description = "Hyprland monitorv2 entries for this host";
        };

        workspaceRules = lib.mkOption {
          type = lib.types.listOf lib.types.str;
          default = [];
          description = "Host-specific Hyprland workspace rules";
        };
      };
      ...
      config = {
        wayland.windowManager.hyprland = {
          ...
          settings = {
            ...
            monitorv2 = config.jv.hyprland.monitorv2;
            ...
            workspace =
              config.jv.hyprland.workspaceRules
              ++ [
                # Smart Gaps
